 ...
 *
 *
 * THIS IS WHERE THE PAGE TRANSITION TRICKERY IS HAPPENING FOR THE PROFILE PHOTO!
 *
 *
 *
 *
...
// They're rendering all of the other profile photos as well.
// but just hiding them.
const ProfilePhoto = styled.div`
  ...
  ${({ pathname, secondary }) => {
    if (!secondary && pathname === "/place") {
      return `
        transform: translate3d(-20px, -100px, 0) scale(1);
      `;
    }
